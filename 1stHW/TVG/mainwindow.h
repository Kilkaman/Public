...
//    MyPlot *m_Plot = new MyPlot();
    ...
    QTimer *TmrRX = new QTimer();
    QThread *thread_TMR = new QThread;//Создаем поток для порта таймера
    char  mass_tst [256];
    char dat[2048];
...
signals:
    ...
    void writeData1(char command);
    void sig_ReadInPort();
    void startTMR();
    void stopTMR();
   // void timeoutTMR(int time);
...
//     void on_horizontalSlider_sliderMoved(int position);
     ...
     void on_B1_butt0_clicked(bool checked);

     void on_B1_butt1_clicked(bool checked);



     void on_B1_butt4_clicked(bool checked);

//     void on_B1_1xxx_clicked(bool checked);

     void on_B1_butt2_clicked(bool checked);
